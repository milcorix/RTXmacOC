...
| 5 | **Display / modeset** — вывод изображения | 🟢 **5A на железе**: дисплейный движок перечислён через GSP (`NV04_DISPLAY_COMMON`, heads=4, displayMask=0x7f00). Аппаратный modeset-трек (Linux/VFIO) идёт; ⛔ интеграция в macOS WindowServer — отдельный трек, замок Apple |
