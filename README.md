...
| 5 | **Display / modeset** — вывод изображения | 🟢 **5A+5B на железе**: движок перечислён (heads=4, 7 выходов), **2 монитора обнаружены, EDID прочитан по DDC** нашим драйвером. Аппаратный modeset-трек (Linux/VFIO) идёт; ⛔ интеграция в macOS WindowServer — отдельный трек, замок Apple |
